...
$(function () {
	$('.layout-1__btn').on('click', function (e) {
		$('html,body').stop().animate({ scrollTop: $('#anchor2').offset().top }, 1000);
		e.preventDefault();
	});
});
$('.layout-1__string-text').marquee({
	duration: 12000,
	gap: 20,
	delayBeforeStart: 0,
	direction: 'left',
...
$('.layout-0__display-2').on('init', function (e, slick) {
	$('.layout-2__benefits-list > div').eq(slick.currentSlide).addClass('layout-2__benefits-list-item--active');
}).slick({
	slidesToShow: 1,
	slidesToScroll: 1,
	arrows: false,
	...
	$('.layout-2__benefits-list > div').removeClass('layout-2__benefits-list-item--active').eq(nextSlide).addClass('layout-2__benefits-list-item--active');
});
$('.layout-2__benefits-list').on('hover', '.layout-2__benefits-list-item', function () {
	$('.layout-0__display-2').slick('slickGoTo', parseInt($(this).text()));
});
$(document).ready(function () {
	console.log('ok');
	$('body').on('mouseenter', '.layout-2__benefits-list-item', function (e) {

		e.preventDefault();
		var slide_num = $(this).index();
		console.log(slide_num);
		$('.layout-0__display-2').slick('slickGoTo', slide_num);
	});
});

$('.layout-0__display-3').slick({
	slidesToShow: 1,
	slidesToScroll: 1,
	fade: true,
	autoplay: true,
...
$('.layout-3__info-slider').slick({
	...
	pauseOnFocus: false,
	pauseOnHover: false,
	// prevArrow: $('.layout-3__arrow'),
});
$('.layout-3__arrow').on('click', function (e) {
	e.preventDefault();
	$('.layout-0__display-3').slick("slickNext");
	$('.layout-3__slider-1').slick("slickNext");
	$('.layout-3__info-slider').slick("slickNext");
});
