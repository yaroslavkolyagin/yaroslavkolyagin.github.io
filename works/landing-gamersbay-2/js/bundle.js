...
$('.line__title').click(function(){
	$(this).toggleClass('line__title--open');
	$(this).parent().children('.line__inner').slideToggle();
});
...
$(".prospectsList__item .btn").hover(
	function(){
		$(this).parent().children('.prospectsList__picture--hover').css('opacity','1')
	},
	function(){
		$(this).parent().children('.prospectsList__picture--hover').css('opacity','0')
	});
