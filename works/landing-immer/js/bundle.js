...
$('a[href*="#"]').click(function () {
	return $page.animate({ scrollTop: $($.attr(this, "href")).offset().top }, 300), !1
})
$('.run-row').slick({
	arrows: false,
	slidesToShow: 9,
...
$('.info__btn-more').click(function (e) {
	$(this).toggleClass('info__btn-more--active')
	$('.info__parameters--hidden').slideToggle('300')
});
$('#control-streamer').click(function (e) {
	$('.form-join__way-streamer').addClass('form-join__way-streamer--active')
	$('.form-join__way-viewer').removeClass('form-join__way-viewer--active')
	$('.form-join__way-viewer input').prop({'checked': false})
	$('.form-join__sending').addClass('form-join__sending--active')
});
$('#control-viewer').click(function (e) {
	$('.form-join__way-viewer').addClass('form-join__way-viewer--active')
	$('.form-join__way-streamer').removeClass('form-join__way-streamer--active')
	$('.form-join__way-streamer input').prop({'checked': false})
	$('.form-join__sending').addClass('form-join__sending--active')
});
$('.btn-open-form').click(function (e) {
	$('body').addClass('cut')
	$('.form-join').addClass('form-join--open')
});
$('#btn-send-join-form').click(function (e) {
	$('.joined').addClass('joined--open')
});
$('.form-join__logo').click(function (e) {
	$('.form-join').removeClass('form-join--open')
	$('.form-join__way-streamer').removeClass('form-join__way-streamer--active')
	$('.form-join__way-viewer').removeClass('form-join__way-viewer--active')
	$('.form-join input').prop({'checked': false})
	$('body').removeClass('cut')
	$('.form-join__sending').removeClass('form-join__sending--active')
});
$('.joined__logo').click(function (e) {
	$('.form-join').removeClass('form-join--open')
	$('.form-join__way-streamer').removeClass('form-join__way-streamer--active')
	$('.form-join__way-viewer').removeClass('form-join__way-viewer--active')
	$('.form-join input').prop({'checked': false})
